...
export class SinglePaymentComponent implements OnInit {
  ...
  constructor(private _ordersService:OrderService,private _userService:OrderDetailsService,private router:Router,private _snackBar:MatSnackBar) {
  ...
  ngOnInit(): void {
    this.singleItem = JSON.parse(sessionStorage.getItem("GiftWithSpecificId") || "");
  }
